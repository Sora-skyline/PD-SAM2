...
def parse_args():
    ...
    parser.add_argument('-i', '--input_dir',default="/home/zy/coding/US_dataset/Echo/EchoNet-Dynamic", type=str)
    parser.add_argument('-o', '--output_dir',default="/home/zy/coding/sam2/sam2/us_dataset/echo", type=str)
...
def preprocess_data(input_path, output_path, save_kpts, save_masks, save_imgs):
    ...
    for fname in fnames:
        ...
        for frame in set(patient_df.Frame):
            ...
            if save_masks:
                cv2.imwrite(os.path.join(anno_folder, f"{name}_{frame}.png"),
